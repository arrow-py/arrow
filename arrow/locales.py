...
class KannadaLocale(Locale):
    ...
    month_names = ['', 'ಜನವರಿ', 'ಫೆಬ್ರವರಿ', 'ಮಾರ್ಚ್', 'ಏಪ್ರಿಲ್ ', 'ಮೇ', 'ಜೂನ್', 'ಜುಲೈ',
                   'ಆಗಸ್ಟ್', 'ಸೆಪ್ಟೆಂಬರ್', 'ಅಕ್ಟೋಬರ್', 'ನವೆಂಬರ್', 'ಡಿಸೆಂಬರ್']
    month_abbreviations = ['', 'ಜನವರಿ', 'ಫೆಬ್ರು', 'ಮಾರ್ಚ್', 'ಏಪ್ರಿ', 'ಮೇ', 'ಜೂನ್', 'ಜುಲೈ', 'ಆಗಸ್ಟ',
                           'ಸೆಪ್ಟೆ', 'ಅಕ್ಟೋ', 'ನವೆಂ', 'ಡಿಸೆಂ']

    day_names = ['', 'ಸೋಮವಾರ', 'ಮಂಗಳವಾರ', 'ಬುಧವಾರ', 'ಗುರುವಾರ', 'ಶುಕ್ರವಾರ', 'ಶನಿವಾರ', 'ರವಿವಾರ']
    day_abbreviations = ['', 'ಸೋಮ', 'ಮಂಗಳ', 'ಬುಧ', 'ಗುರ', 'ಶುಕ್ರ', 'ಶನಿ', 'ರವಿ']
