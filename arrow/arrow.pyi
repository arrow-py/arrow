...
class Arrow(object):
    ...
    _SECS_PER_MINUTE: ClassVar[float] = ...
    _SECS_PER_HOUR: ClassVar[float] = ...
    _SECS_PER_DAY: ClassVar[float] = ...
    _SECS_PER_WEEK: ClassVar[float] = ...
    _SECS_PER_MONTH: ClassVar[float] = ...
    _SECS_PER_YEAR: ClassVar[float] = ...
