...
class DateTimeParser(object):
    ...
    def _parse_token(self, char* token, value, parts):

        if strcmp(token, "YYYY") == 0:
            parts["year"] = int(value)

        elif strcmp(token, "YY") == 0:
            value = int(value)
            parts["year"] = 1900 + value if value > 68 else 2000 + value

        elif strcmp(token, "MMMM") == 0 or strcmp(token, "MMM") == 0:
            parts["month"] = self.locale.month_number(value.lower())

        elif strcmp(token, "MM") == 0 or strcmp(token, "M") == 0:
            parts["month"] = int(value)

        elif strcmp(token, "DDDD") == 0 or strcmp(token, "DDD") == 0:
            parts["day_of_year"] = int(value)

        elif strcmp(token, "DD") == 0 or strcmp(token, "D") == 0:
            parts["day"] = int(value)
...
class TzinfoParser(object):
    ...
    @classmethod
    def parse(cls, char* tzinfo_string):

        tzinfo = None

        if strcmp(tzinfo_string, "local") == 0:
            tzinfo = tz.tzlocal()

        elif strcmp(tzinfo_string, "utc") == 0 or strcmp(tzinfo_string, "UTC") == 0 or strcmp(tzinfo_string, "Z") == 0:
            tzinfo = tz.tzutc()
