...
class ArrowHumanizeTests(Chai):
    ...
    def test_granularity(self):
        ...
        assertEqual(self.now.humanize(later105, granularity = 'week'), '0 weeks ago')
        assertEqual(later105.humanize(self.now, granularity = 'week'), 'in 0 weeks')
        ...
        assertEqual(self.now.humanize(later106, granularity = 'week'), '4 weeks ago')
        assertEqual(later106.humanize(self.now, granularity = 'week'), 'in 4 weeks')
        ...
        assertEqual(self.now.humanize(later506, granularity = 'week'), '82 weeks ago')
        assertEqual(later506.humanize(self.now, granularity = 'week'), 'in 82 weeks')
