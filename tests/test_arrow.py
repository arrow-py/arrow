...
class TestArrowDehumanize:
    ...
    def test_locale_hindi(self):
        ...
        assert arw.dehumanize("दो साल पहले", "hi") == arrow.Arrow(
            2012, 4, 18, 12, 30, 0
        )
    ...
    def test_locale_french(self):
        ...
        assert arw.dehumanize("dans cinq mois", "fr") == arrow.Arrow(
            2014, 9, 18, 12, 30, 0
        )
        ...
        assert arw.dehumanize("dans trois heures", "fr") == arrow.Arrow(
            2014, 4, 18, 15, 30, 0
        )
        assert arw.dehumanize("dans cinq mois", "fr") == arrow.Arrow(
            2014, 9, 18, 12, 30, 0
        ...
        assert arw.dehumanize("dans 365 jours", "fr") == arrow.Arrow(
            2015, 4, 18, 12, 30, 0
        )
    ...
    def test_locale_german(self):
        ...
        assert arw.dehumanize("vor zwei Minuten", "de") == arrow.Arrow(
            2014, 4, 18, 12, 28, 0
        )
        assert arw.dehumanize("in drei Stunden", "de") == arrow.Arrow(
            2014, 4, 18, 15, 30, 0
        )
        assert arw.dehumanize("in fünf Monaten", "de") == arrow.Arrow(
            2014, 9, 18, 12, 30, 0
        )
