...
class PolishLocalesTests(Chai):
    ...
    def test_plurals(self):
        ...
        assertEqual(locale._format_timeframe('hours', 1), '1 godzina')
        ...
        assertEqual(locale._format_timeframe('minutes', 0), '0 minut')
        assertEqual(locale._format_timeframe('minutes', 1), '1 minuta')
        assertEqual(locale._format_timeframe('minutes', 2), '2 minuty')
        assertEqual(locale._format_timeframe('minutes', 4), '4 minuty')
        assertEqual(locale._format_timeframe('minutes', 5), '5 minut')
        assertEqual(locale._format_timeframe('minutes', 21), '21 minut')
        assertEqual(locale._format_timeframe('minutes', 22), '22 minuty')
        assertEqual(locale._format_timeframe('minutes', 25), '25 minut')
